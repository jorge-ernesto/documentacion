...
```bash
1 master-python-web              # no se usa virtualizacion ----> python instalado en laragon  ----> python-3.10 (python-3.10.6)
2 master-python-odoo             # se usa virtualizacion    ----> python instalado en laragon  ----> revisar notas de virtualizacion ----> master-python-odoo, 1-aprendiendo-odoo                      ----> python-3.12.7
3 master-python-datascience      # se usa virtualizacion    ----> python instalado en anaconda ----> revisar notas de virtualizacion ----> master-python-datascience, 1-python-datascience-newhorizons ----> base (base-3.12.4), base-3.10.12
4 master-python-dataengineering  # se usa virtualizacion    ----> python instalado en laragon  ----> revisar notas de virtualizacion ----> master-python-dataengineering, 1-aprendiendo-pyspark        ----> python-3.11.8
```
