...
3 master-python-dataengineering  # python instalado en laragon  ----> python-3.11.8                    ----> se usa virtualizacion, revisar notas de virtualizacion ----> master-python-dataengineering, 1-aprendiendo-pyspark
4 master-python-odoo             # python instalado en laragon  ----> python-3.12.7                    ----> se usa virtualizacion, revisar notas de virtualizacion ----> master-python-odoo, 1-aprendiendo-odoo
```
