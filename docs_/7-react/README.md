...
Podemos entrar a la web oficial de [GIPHY Developers](https://developers.giphy.com/)
Podemos entrar a la web oficial de [Netlify](https://app.netlify.com/)
...
::: tip Documentación Legacy
* [Estructura de archivos](https://es.legacy.reactjs.org/docs/faq-structure.html)
:::

* [Bug: unexpected Warning: ReactDOMTestUtils.act is deprecated in favor of React.act](https://github.com/facebook/react/issues/29000)
...
# Luego lo siguiente
    ...
    npm start     # Levantamos el proyecto
    npm run test  # Levantamos las pruebas con React Testing Library y Jest
...
# Dependencias
    ...
    npm install @testing-library/react  # Instalamos @testing-library/react ----> Por el error: ReactDOMTestUtils.act is deprecated
...
```
npx create-react-app 04-gif-expert-app  # Crear el proyecto de React sin instalar "create-react-app"
