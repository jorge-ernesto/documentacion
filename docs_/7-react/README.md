...
Podemos entrar a la web oficial de [Pagina de Jest](https://jestjs.io/)<br />
...
2. Se usara `npx create-react-app` y `npm create vite` por lo que no es necesario instalar dependencias globalmente
...
### 03-counter-app-cra (react-cero-experto)
::: tip Notas de la instalación
* Cuando cree este proyecto lo hice con **Node 18.14.0** instala **NPM 9.3.1**
:::

```
npx create-react-app 03-counter-app-cra  # Crear el proyecto de React sin instalar "create-react-app"
...
### 03-counter-app-vite (react-cero-experto)
::: tip Notas de la instalación
* Cuando cree este proyecto lo hice con **Node 18.14.0** instala **NPM 9.3.1**
:::

**NPM:**
* [Instalamos prop-types](https://www.npmjs.com/package/prop-types)
* [Instalamos jest](https://jestjs.io/es-ES/docs/getting-started)
* [Instalamos @types/jest](https://jestjs.io/es-ES/docs/getting-started)
----
[**Learn:**](https://es.react.dev/learn)
* [Tutorial](https://es.react.dev/learn/tutorial-tic-tac-toe)
* [Responder a eventos](https://es.react.dev/learn/responding-to-events)
----
[**Reference:**](https://es.react.dev/reference/react)
* **react**
...
```
npm create vite  # Crear el proyecto de React con "create-vite"
...
# Luego lo siguiente
    Project name: 03-counter-app-vite
...
# Luego de instalar Jest (Pruebas unitarias y de integración)
    npm run test  # Levantamos las pruebas con Jest

# Dependencias
    Las dependencias siempre estan instaladas en packgage.json del proyecto

    npm i prop-types                                                 # Instalamos prop-types
    npm install --save-dev jest                                      # Instalamos jest
    npm install --save-dev @types/jest                               # Instalamos @types/jest ----> Paquete de tipos de TypeScript para Jest, proporciona información sobre los tipos de datos y funciones utilizados por Jest en tu proyecto.
    npm install --save-dev babel-jest @babel/core @babel/preset-env  # Instalamos babel-jest ----> Configuración de Babel
