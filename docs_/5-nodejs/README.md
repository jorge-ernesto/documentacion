...
También podemos ver las [Versiones de Node](https://nodejs.org/es/download/releases/)
```bash
node -v
npm -v
```
...
* [Configurar el acceso CORS en NodeJS](https://victorroblesweb.es/2018/01/31/configurar-acceso-cors-en-nodejs/)
